...
/**
 * @author ziyu.zhou
 * @date 2018/7/30 13:43
 */

@Entity
@Table(name = "rule_shouyezhenduan", schema = "jhmk_waring", catalog = "")
public class Shouyezhenduan extends Zhenduan{
    ...
    public int hashCode() {
        ...
        return Objects.hash(super.hashCode(), id, visit_id, patient_id, diagnosis_name, diagnosis_desc, diagnosis_time, diagnosis_num, diagnosis_sub_num, diagnosis_type_name);
    }
}
